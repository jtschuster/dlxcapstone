...
set_log_file fv/readReg/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/readReg -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k lib/dec_n.v lib/mux_32.v lib/readReg.v
elaborate_design -golden -root {readReg} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/readReg/fv_map.v.gz
elaborate_design -revised -root {readReg}
