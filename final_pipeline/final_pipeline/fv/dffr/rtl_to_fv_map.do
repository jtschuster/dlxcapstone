...
# Generated on: Wed Mar 03 16:49:45 CST 2021 (Wed Mar 03 22:49:45 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/dffr/rtl_to_fv_map.log -replace
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k lib/dffr.v
