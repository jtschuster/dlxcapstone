...
# Generated on: Wed Mar 03 16:49:43 CST 2021 (Wed Mar 03 22:49:43 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/forwarding_ex/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/forwarding_ex -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k lib/or_gate.v lib/dff.v lib/mux_32.v lib/xor_gate.v lib/mux.v lib/forwarding_ex.v
elaborate_design -golden -root {forwarding_ex} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/forwarding_ex/fv_map.v.gz
elaborate_design -revised -root {forwarding_ex}
...
#add_name_alias fv/forwarding_ex/fv_map.singlebit.original_name.alias.json.gz -revised
