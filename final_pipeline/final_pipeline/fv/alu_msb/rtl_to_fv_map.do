...
set_log_file fv/alu_msb/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/alu_msb -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k lib/not_gate.v lib/and_gate.v lib/or_gate.v lib/xor_gate.v lib/mux.v lib/alu_msb.v
elaborate_design -golden -root {alu_msb} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/alu_msb/fv_map.v.gz
elaborate_design -revised -root {alu_msb}
