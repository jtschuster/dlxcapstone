...
# Generated on: Wed Mar 03 16:49:38 CST 2021 (Wed Mar 03 22:49:38 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/writeReg/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/writeReg -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k lib/and_gate.v lib/dec_n.v lib/dff.v lib/mux_32.v lib/write32.v lib/writeReg.v
elaborate_design -golden -root {writeReg} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/writeReg/fv_map.v.gz
elaborate_design -revised -root {writeReg}
