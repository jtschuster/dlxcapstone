...
# Generated on: Wed Mar 03 16:49:41 CST 2021 (Wed Mar 03 22:49:41 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/Control/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/Control -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k lib/mux_n.v lib/not_gate_n.v lib/and_gate.v lib/or_gate.v lib/dff.v lib/mux.v lib/and_6.v lib/Control_signal.v
elaborate_design -golden -root {Control} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Control/fv_map.v.gz
elaborate_design -revised -root {Control}
...
#add_name_alias fv/Control/fv_map.singlebit.original_name.alias.json.gz -revised
