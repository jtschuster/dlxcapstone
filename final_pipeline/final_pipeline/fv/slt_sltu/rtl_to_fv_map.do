...
# Generated on: Wed Mar 03 16:49:37 CST 2021 (Wed Mar 03 22:49:37 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/slt_sltu/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/slt_sltu -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k lib/mux.v lib/slt_sltu.v
elaborate_design -golden -root {slt_sltu} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/slt_sltu/fv_map.v.gz
elaborate_design -revised -root {slt_sltu}
