...
set_log_file fv/srl/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/srl -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k lib/and_gate.v lib/or_gate_32.v lib/mux_32.v lib/srl.v
elaborate_design -golden -root {srl} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/srl/fv_map.v.gz
elaborate_design -revised -root {srl}
