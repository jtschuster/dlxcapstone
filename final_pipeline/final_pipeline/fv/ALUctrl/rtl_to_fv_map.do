...
# Generated on: Wed Mar 03 16:49:44 CST 2021 (Wed Mar 03 22:49:44 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/ALUctrl/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/ALUctrl -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k lib/mux_n.v lib/not_gate.v lib/and_gate.v lib/or_gate.v lib/xor_gate.v lib/ALUctrl.v
elaborate_design -golden -root {ALUctrl} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ALUctrl/fv_map.v.gz
elaborate_design -revised -root {ALUctrl}
