...
set_log_file fv/or_gate/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/or_gate -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../or_gate.v
elaborate_design -golden -root {or_gate} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/or_gate/fv_map.v.gz
elaborate_design -revised -root {or_gate}
