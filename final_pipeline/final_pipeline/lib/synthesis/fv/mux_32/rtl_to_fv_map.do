...
set_log_file fv/mux_32/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mux_32 -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../mux_32.v
elaborate_design -golden -root {mux_32} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mux_32/fv_map.v.gz
elaborate_design -revised -root {mux_32}
