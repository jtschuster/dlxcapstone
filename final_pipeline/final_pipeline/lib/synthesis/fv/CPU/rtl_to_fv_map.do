...
# Generated on: Sat Jan 30 21:06:25 CST 2021 (Sun Jan 31 03:06:25 GMT 2021)
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../mux_n.v ../not_gate_n.v ../not_gate.v ../and_gate.v ../or_gate_32.v ../or_gate.v ../dec_n.v ../dffr.v ../xnor_gate.v ../dff.v ../mux_32.v ../xor_gate.v ../mux.v ../alu_32.v ../EX_stage.v ../ALUctrl.v ../Extender.v ../alu_msb.v ../forwarding_ex.v ../srl.v ../alu_unit.v ../full_alu.v ../and_6.v ../ID_stage.v ../ifecth.v ../Control_signal.v ../IF_stage.v ../PC.v ../WB_stage.v ../readReg.v ../write32.v ../Mem_stage.v ../RegisterFiles.v ../writeReg.v ../sll.v ../CPU.v
