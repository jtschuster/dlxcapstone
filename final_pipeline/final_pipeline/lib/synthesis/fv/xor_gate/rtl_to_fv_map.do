...
# Generated on: Sat Jan 30 21:01:06 CST 2021 (Sun Jan 31 03:01:06 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/xor_gate/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/xor_gate -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../xor_gate.v
elaborate_design -golden -root {xor_gate} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/xor_gate/fv_map.v.gz
elaborate_design -revised -root {xor_gate}
