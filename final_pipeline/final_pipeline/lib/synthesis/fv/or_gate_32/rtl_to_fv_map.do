...
# Generated on: Sat Jan 30 21:01:09 CST 2021 (Sun Jan 31 03:01:09 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/or_gate_32/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/or_gate_32 -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../or_gate_32.v
elaborate_design -golden -root {or_gate_32} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/or_gate_32/fv_map.v.gz
elaborate_design -revised -root {or_gate_32}
