...
# Generated on: Sat Jan 30 21:01:10 CST 2021 (Sun Jan 31 03:01:10 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/not_gate_n/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/not_gate_n -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../not_gate_n.v
elaborate_design -golden -root {not_gate_n} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/not_gate_n/fv_map.v.gz
elaborate_design -revised -root {not_gate_n}
